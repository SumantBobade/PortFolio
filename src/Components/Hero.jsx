    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col-reverse items-center justify-between gap-20 px-6 pt-32 lg:flex-row">
        ...
        >
          ...
          <h3 className="mt-10 text-xl text-slate-400">
            Hello, I'm
          </h3>
          ...
          <p className="mt-8 max-w-xl text-lg leading-8 text-slate-400">
            ...
            AI-powered software, and immersive gameplay experiences.
        ...
        >
          ...
          <motion.div
            ...
            className="absolute left-0 top-10 rounded-full border border-white/10 bg-slate-900/70 px-5 py-3 backdrop-blur-xl"
          >
          ...
          <motion.div
            ...
            className="absolute right-0 top-28 rounded-full border border-white/10 bg-slate-900/70 px-5 py-3 backdrop-blur-xl"
          >
          ...
          <motion.div
            ...
            className="absolute -left-2 bottom-28 rounded-full border border-white/10 bg-slate-900/70 px-5 py-3 backdrop-blur-xl"
          >
          ...
          <motion.div
            ...
            className="absolute right-2 bottom-8 rounded-full border border-white/10 bg-slate-900/70 px-5 py-3 backdrop-blur-xl"
          >
